import argparse
from ..project\snn-code import IncreasingInhibitionNetwork
import argparse
import os
...
for epoch in range(n_epochs):
    ...
    dataloader = torch.utils.data.DataLoader(dataset, batch_size=1, shuffle=True, num_workers=n_workers, pin_memory=gpu)
